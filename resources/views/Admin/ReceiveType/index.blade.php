      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h6 style="float: right">كل طرق الاستلام</h6>
            <a style="float: left" href="{{route('admin.ReceiveType.create')}}"><button class="btn btn-success">اضافة  طرق الاستلام</button></a>   
          </div>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ">الاستلام</th>
                    ...
                    @foreach ($branches as $branch)
                        <tr>
                            ...
                            <td class="align-middle">
                                <a href="{{route('admin.ReceiveType.edit', $branch->id)}}"><button class="btn btn-primary">تعديل </button></a>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="POST" action="{{ Route('admin.ReceiveType.delete') }}">
                        @csrf
