      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h6 style="float: right">كل الفروع</h6>
            <a style="float: left" href="{{route('admin.branches.create')}}"><button class="btn btn-success">اضافة فرع</button></a>   
          </div>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ">اسم الفرع</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder">العنوان</th>
                    ...
                    @foreach ($branches as $branch)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex px-2 py-1">
                                    <div class="d-flex flex-column justify-content-center">
                                    <p class="text-xs text-secondary mb-0">{{ $branch->address ?? '--' }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="align-middle">
                                <a href="{{route('admin.branches.edit', $branch->id)}}"><button class="btn btn-primary">تعديل </button></a>
