                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div>
                          <img src="{{asset('dashboard/assets/img/small-logos/logo-xd.svg')}}" class="avatar avatar-sm ms-3">
                        </div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div>
                          <img src="{{asset('dashboard/assets/img/small-logos/logo-atlassian.svg')}}" class="avatar avatar-sm ms-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div>
                          <img src="{{asset('dashboard/assets/img/small-logos/logo-slack.svg')}}" class="avatar avatar-sm ms-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div>
                          <img src="{{asset('dashboard/assets/img/small-logos/logo-spotify.svg')}}" class="avatar avatar-sm ms-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div>
                          <img src="{{asset('dashboard/assets/img/small-logos/logo-jira.svg')}}" class="avatar avatar-sm ms-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div>
                          <img src="{{asset('dashboard/assets/img/small-logos/logo-invision.svg"')}} class="avatar avatar-sm ms-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
