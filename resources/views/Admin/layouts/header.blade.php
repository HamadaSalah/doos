...
<head>
  ...
  <link href="{{ asset('dashboard/assets/css/nucleo-svg.css')}}" rel="stylesheet" />
  <!-- CSS Files -->
  <script src="https://use.fontawesome.com/e67bbf3dac.js"></script>
  <script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
  <link href="{{ asset('dashboard/assets/css/viewer.css')}}" rel="stylesheet" />
  <script src="{{ asset('dashboard/assets/js/viewer.js')}}"></script>
