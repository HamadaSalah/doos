                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="mycardata">
                            ...
                            <div class="raduisadata">{{ $user->name }}</div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="mycardata">
                            <label for="">البريد</label>
                            <div class="raduisadata">{{ $user->email }}</div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="mycardata">
                            <label for="">الموبايل</label>
                            <div class="raduisadata">{{ $user->phone }}</div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="mycardata">
                            <label for="">تاريخ الميلاد</label>
                            <div class="raduisadata">{{ $user->birthday }}</div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="mycardata">
                            <label for="">حالة الرخصة</label>
                            <div class="raduisadata">{{ $user->licence_status==1 ? 'سارية' : 'منتهية' }}</div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="mycardata">
